...
public class Coloreador {
    ...
    /**
     * Modifica el tamaño de fuente para todos los estilos y guarda el nuevo valor.
     * @param newSize El nuevo tamaño de fuente (en puntos).
     */
    public void cambiarTamaño(int newSize) {
        if (newSize > 0) {
            this.fontSizeID = newSize;
            
            // Aplicar el nuevo tamaño a CADA estilo
            StyleConstants.setFontSize(estiloDefault, newSize); 
            StyleConstants.setFontSize(estiloKeyword, newSize);
            StyleConstants.setFontSize(estiloNumero, newSize);
            StyleConstants.setFontSize(estiloCadena, newSize);
            StyleConstants.setFontSize(estiloComentario, newSize);
            StyleConstants.setFontSize(estiloID, newSize);
            

            colorear(); // Reaplicar los estilos
        }
    }
